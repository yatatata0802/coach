          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
                <div className="text-center p-6 sm:p-8 bg-white/5 backdrop-blur-sm border border-[#d4af37]/20 rounded-2xl">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 bg-gradient-to-br from-[#d4af37] to-[#ffd700] rounded-full flex items-center justify-center">
                ...
                <div className="text-center p-6 sm:p-8 bg-white/5 backdrop-blur-sm border border-[#d4af37]/20 rounded-2xl">
                  ...
                  <p className="text-gray-300 text-sm sm:text-base">
                    習慣化とモチベーション維持のための実践的なサポートを提供します。
                  </p>
                </div>
                ...
                <div className="text-center p-6 sm:p-8 bg-white/5 backdrop-blur-sm border border-[#d4af37]/20 rounded-2xl">
                  ...
                  <p className="text-gray-300 text-sm sm:text-base">
                    自己管理力とメンタル面の両方から統合的な成長をサポートします。
                  </p>
                </div>
              </div>
